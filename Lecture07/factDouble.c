...
*
* Modifies factFloat.c by changing the result type to a double 
* so that we can get a greater range of results than float.
* Deliberately exceeds 170 to show the students that the 
* range of doubles has a limit
**********************************************/
...
void printFactorial( int num, double result ){
	...
	fprintf(stdout, "Value of %d! is %lf. Hex is %a\n", num, result, result);
}
